...
from doc_parser.discovery import ServiceDiscoveryEngine, DiscoveryConfig
from doc_parser.discovery.models import (
...
async def get_services_by_type(service_type: str):
    """按类型获取服务"""
    from doc_parser.discovery import ServiceType
...
async def get_services_by_capability(capability: str):
    """按能力获取服务"""
    from doc_parser.discovery import ServiceCapability
